...
2. 点击请求证书
3. 选择请求公有证书, 点击下一步
4. 输入完全限定域名, 一次一个域名配置一个证书(也可以一次多个, 如: a.com 和 www.a.com)
5. 验证方法选择 DNS 验证
6. 密钥算法选择 RSA 2048
...
3. 输入源域 http://abcdcdn.com，协议选项选择仅 HTTP，HTTP 端口 80，若你同一台服务器不希望有多个 CDN源域名的话，那么可以通过端口来进行区分，如客户端使用 80，MIS使用8081 等等
